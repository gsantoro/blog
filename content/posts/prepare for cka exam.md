...
- [Kubernetes: Up and Running, 3rd Edition](https://www.google.co.uk/books/edition/Kubernetes_Up_and_Running/K5Q0DwAAQBAJ?hl=en&gbpv=0) - Good starting point if you are new to Kubernetes.
- [Certified Kubernetes Administrator (CKA) Study Guide](https://www.google.co.uk/books/edition/Certified_Kubernetes_Administrator_CKA_S/fG0TzwEACAAJ?hl=en) - It covers the CKA exam and gives a more a in-depth description of administering a Kubernetes cluster.
- [Managing Kubernetes](https://www.google.co.uk/books/edition/Managing_Kubernetes/UG15DwAAQBAJ?hl=en&gbpv=0) - It goes deeper into how to manage a Kubernetes cluster if you are a DevOps. It covers some topics that are not in the study guide.
- [Cloud Native DevOps with Kubernetes, 2nd Edition](https://www.google.co.uk/books/edition/Cloud_Native_DevOps_with_Kubernetes/WEyMDwAAQBAJ?hl=en&gbpv=0) - It covers lots of tools and techniques to observe and monitor your Kubernetes cluster. Optional book for the exam.
...
The very first book I read on the topic is [Kubernetes: Up and Running, 3rd Edition](https://www.google.co.uk/books/edition/Kubernetes_Up_and_Running/K5Q0DwAAQBAJ?hl=en&gbpv=0).

{{< image src="/images/kubernetes_up_and_running.256.jpg" title="Kubernetes: Up and Running" width="128px" >}}
...
The second book I read on the topic is [Certified Kubernetes Administrator (CKA) Study Guide](https://www.google.co.uk/books/edition/Certified_Kubernetes_Administrator_CKA_S/fG0TzwEACAAJ?hl=en).

{{< image src="/images/cka_study_guide.256.jpg" title="Kubernetes: Up and Running" width="128px" >}}
...
### Managing Kubernetes
Once you have done the simulator exam (like I suggested in the previous section), make sure to explore some of those topics that you are not very familiar with from the book [Managing Kubernetes](https://www.google.co.uk/books/edition/Managing_Kubernetes/UG15DwAAQBAJ?hl=en&gbpv=0).

{{< image src="/images/managing_kubernetes.256.jpg" title="Kubernetes: Up and Running" width="128px" >}}
...
Finally, I would suggest you read [Cloud Native DevOps with Kubernetes, 2nd Edition](https://www.google.co.uk/books/edition/Cloud_Native_DevOps_with_Kubernetes/WEyMDwAAQBAJ?hl=en&gbpv=0). I found this book very interesting because it is a reference to many different tools in the growing ecosystem of Kubernetes.

{{< image src="/images/cloud_native_devops_kubernetes.256.jpg" title="Kubernetes: Up and Running" width="128px" >}}
